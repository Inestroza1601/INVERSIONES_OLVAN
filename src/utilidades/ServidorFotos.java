...
public class ServidorFotos extends NanoHTTPD {
    ...
    private String getHtmlTemplate() {
        ...
        sb.append("    <title>Subir Fotos de Garantía</title>\n");
        sb.append("    <style>\n");
        ...
        sb.append("        .slot { position: relative; width: 100%; aspect-ratio: 1; border: 2px dashed #bdc3c7; border-radius: 8px; display: flex; align-items: center; justify-content: center; overflow: hidden; background: #fafafa; }\n");
        ...
        sb.append("        <p>Toca cada recuadro para capturar (Máximo 4 fotos).</p>\n");
        sb.append("        <div class=\"grid\">\n");
        for (int i = 1; i <= 4; i++) {
            sb.append("            <div class=\"slot\" id=\"slot" + i + "\">\n");
            sb.append("                <span class=\"slot-text\">Foto " + i + "</span>\n");
            sb.append("                <img id=\"preview" + i + "\" src=\"\" alt=\"\">\n");
            sb.append("                <input type=\"file\" accept=\"image/*\" class=\"foto-input\" data-slot=\"" + i + "\" " + (!mostrarGaleria ? "capture=\"environment\"" : "") + ">\n");
            sb.append("            </div>\n");
        }
        sb.append("        </div>\n");
        ...
        sb.append("        let fotosBase64 = [null, null, null, null];\n");
        ...
        sb.append("                    const slotIndex = parseInt(this.getAttribute('data-slot')) - 1;\n");
        ...
        sb.append("                            fotosBase64[slotIndex] = finalBase64;\n");
        sb.append("                            const preview = document.getElementById('preview' + (slotIndex + 1));\n");
