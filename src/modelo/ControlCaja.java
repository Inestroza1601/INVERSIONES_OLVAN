...
public class ControlCaja {
    ...
    public double getMontoCierreEsperado() { return montoCierreEsperado; }
    public void setMontoCierreEsperado(double montoCierreEsperado) { this.montoCierreEsperado = montoCierreEsperado; }

    public double getMontoCierreReal() { return montoCierreReal; }
    public void setMontoCierreReal(double montoCierreReal) { this.montoCierreReal = montoCierreReal; }

    public double getDiferenciaCierre() { return diferenciaCierre; }
    public void setDiferenciaCierre(double diferenciaCierre) { this.diferenciaCierre = diferenciaCierre; }

    public String getObservaciones() { return observaciones; }
    public void setObservaciones(String observaciones) { this.observaciones = observaciones; }

    public String getCajeroTurno() { return cajeroTurno; }
    public void setCajeroTurno(String cajeroTurno) { this.cajeroTurno = cajeroTurno; }
    ...
    public int getEstadoCaja() { return estadoCaja; }
    public void setEstadoCaja(int estadoCaja) { this.estadoCaja = estadoCaja; }
