...
public class DialogoMovimientoKardex extends JDialog {
    ...
    private void iniciarDiseno() {
        ...
        rbAgregar = new JRadioButton("Entrada (+)"); rbAgregar.setForeground(new Color(39, 174, 96)); rbAgregar.setBackground(new Color(255, 255, 255)); // Verde Menta
        rbDisminuir = new JRadioButton("Salida (-)"); rbDisminuir.setForeground(new Color(227, 0, 15)); rbDisminuir.setBackground(new Color(255, 255, 255)); // Rojo Logo
        ...
        // Cantidad
        JLabel lblCantidad = new JLabel("Cantidad:"); lblCantidad.setForeground(new Color(45, 45, 45)); // Gris Oscuro
        ...
        txtCantidad.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(new Color(220, 222, 225)), BorderFactory.createEmptyBorder(8, 10, 8, 10)));
        ...
        // Observación
        JLabel lblObs = new JLabel("Motivo u Observación:"); lblObs.setForeground(new Color(45, 45, 45)); // Gris Oscuro
        ...
        JScrollPane scrollObs = new JScrollPane(txtObservacion); scrollObs.setBorder(BorderFactory.createLineBorder(new Color(220, 222, 225)));
        ...
        // Botones
        JPanel pnlBotones = new JPanel(new FlowLayout(FlowLayout.RIGHT, 15, 15)); pnlBotones.setBackground(new Color(240, 242, 245)); // Gris Nube
        JButton btnCancelar = new JButton("Cancelar"); btnCancelar.setBackground(new Color(140, 145, 150)); btnCancelar.setForeground(Color.WHITE); btnCancelar.addActionListener(e -> this.dispose()); // Gris Suave
        JButton btnGuardar = new JButton("Firmar Movimiento"); btnGuardar.setBackground(new Color(39, 174, 96)); btnGuardar.setForeground(Color.WHITE); // Verde Menta
