...
public class PanelHistorialVentas extends JPanel {
        ...
        private void iniciarDiseno() {
                ...
                // Tabla
                String[] cols = { "ID Venta", "Tipo", "Fecha / Hora", "Cliente", "Método Pago", "Vendedor", "Subtotal",
                                "ISV (15%)",
                                "Total" };
        ...
        private void filtrarVentas() {
                ...
                for (Object[] v : ventas) {
                        ...
                        if (client.contains(filter) || method.contains(filter) || seller.contains(filter)
                                        || idStr.contains(filter) || dni.contains(filterClean)
                                        || dni.contains(filter)) {
        ...
        private void verDetallesVenta() {
                ...
                if (esApartado) {
                        ...
                        String infoExtra = (ref != null && !ref.isEmpty() ? ref : "N/A")
                                        + (banco != null && !banco.isEmpty() ? " (" + banco + ")" : "");
        ...
        private void reimprimirTicket() {
                ...
                chooser.setSelectedFile(
                                new File("Reimpresion_Factura_" + idVenta + "_" + System.currentTimeMillis() + ".pdf"));
