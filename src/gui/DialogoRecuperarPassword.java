...
<<<<<<< HEAD
        ...
        JLabel lblInstrucciones = new JLabel(
                "<html><body>Ingrese su nombre de usuario.<br>Verificaremos su cuenta y enviaremos el código a su correo.</body></html>");
...
>>>>>>> origin/parte-muoz
        ...
        gbc.gridy = 1;
        pnlFondo.add(lblInstrucciones, gbc);
        gbc.gridy = 2;
...
>>>>>>> origin/parte-muoz
    ...
    private void enviarCodigo() {
        ...
        if (nombreUsuario.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor ingrese su nombre de usuario.", "Atención",
