...
public class PanelCrearProducto extends JPanel {
    ...
    private void iniciarDiseno() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                if (indiceImagenActual >= 0 && indiceImagenActual < imagenesSeleccionadas.size()) {
                    ...
                    if (window instanceof Frame) {
                        new DialogoVisorImagen((Frame) window, "Visor de Fotografía", imagenesSeleccionadas,
                                indiceImagenActual).setVisible(true);
                    } else if (window instanceof JDialog) {
                        new DialogoVisorImagen((JDialog) window, "Visor de Fotografía", imagenesSeleccionadas,
                                indiceImagenActual).setVisible(true);
                    }
                }
            }
        ...
        btnTomarFoto.addActionListener(e -> {
            if (imagenesSeleccionadas.size() >= 7) {
                JOptionPane.showMessageDialog(this, "Límite de 7 imágenes alcanzado.", "Límite Excedido",
    ...
    private void limpiarFormulario() {
        ...
        chkIncluyeImpuesto.setSelected(false);
    }
    ...
    private void seleccionarImagen() {
        ...
        FileNameExtensionFilter filter = new FileNameExtensionFilter("Imágenes (JPG, PNG, GIF, JPEG)", "jpg", "png",
                "gif", "jpeg");
        ...
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Error al leer el archivo de imagen.", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void cargarImagenDesdeURL() {
        ...
        String urlStr = JOptionPane.showInputDialog(this, "Ingrese la URL de la imagen:", "Cargar desde la Web",
        ...
        SwingWorker<String, Void> worker = new SwingWorker<String, Void>() {
            ...
            protected String doInBackground() throws Exception {
                ...
                if (img == null)
                    throw new Exception("La URL no contiene una imagen válida.");
            ...
            protected void done() {
                ...
                try {
                    ...
                    indiceImagenActual = imagenesSeleccionadas.size() - 1;
                    actualizarVistaPreviaImagen();
                    JOptionPane.showMessageDialog(PanelCrearProducto.this,
                            "Imagen descargada y adjuntada exitosamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                } catch (Exception ex) {
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(PanelCrearProducto.this,
                            "⚠️ No se pudo descargar la imagen.\nVerifique que la URL sea válida o que tenga conexión a internet (No WiFi).",
    ...
    private void actualizarVistaPreviaImagen() {
        if (imagenesSeleccionadas.isEmpty() || indiceImagenActual < 0
                || indiceImagenActual >= imagenesSeleccionadas.size()) {
